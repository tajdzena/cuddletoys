    ...
    <div class="flex flex-col md:flex-row gap-6 mt-10">
        ...
        <div class="w-full md:w-3/4 bg-brighter-peach rounded-lg shadow-lg p-6">
            <table class="min-w-full leading-normal">
                ...
                <x-korpa-proizvod image="/images/igracke/zaba/zaba1.png" vrsta="igracka" naziv="Žaba" boja_vunice="zelena" boja_ociju="plava" dimenzije="15x30x30" cena="900" kolicina="1" />
                ...
                <x-korpa-proizvod image="/images/igracke/zaba/zaba1.png" vrsta="igracka" naziv="Žaba" boja_vunice="zelena" boja_ociju="plava" dimenzije="30x60x60" cena="900" kolicina="1" />
