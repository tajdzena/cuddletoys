            ...
            <div id="pracenje" class="section hidden">
                ...
                <div class="bg-brighter-peach rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <x-card-porudzbina
                        ...
                        broj_posiljke="3450465"
                        adresa_isporuke="Beograd, Adresa 123, 11000"
                        adresa_placanja="Beograd, Adresa 123, 11000"
                        status_posiljke="U izradi"
                ...
                <div class="bg-brighter-peach rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <x-card-porudzbina
                        broj_posiljke="3450425"
                        adresa_isporuke="Novi Sad, Adresa 456, 21000"
                        adresa_placanja="Novi Sad, Adresa 456, 21000"
                        status_posiljke="Isporučena"
