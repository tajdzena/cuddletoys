<x-nav>
    <title>Prijava - CuddleToys</title>
</x-nav>
    ...
    <div class="flex justify-center">
        <div class="w-full max-w-md bg-brighter-peach rounded-lg shadow-lg p-6">
            <form action="#" method="POST">
                ...
                <x-label-input for="mejl_ili_kor_ime" text="Mejl ili korisničko ime" type="text" id="mejl_ili_kor_ime" name="mejl_ili_kor_ime" placeholder="pera.peric@gmail.com ili peraperic"></x-label-input>

                <!-- Input za lozinku sa dugmetom za toggle -->
                <div class="relative mb-4">
                    <x-label-input for="lozinka" text="Lozinka" type="password" id="lozinka" name="lozinka" placeholder="Unesi lozinku"></x-label-input>
